...
void loop() {
  ...
  } else if(15 < distance && distance < 30){  //if the object is a medium distance
  ...
  } else if(30 < distance && distance < 60){                                     //if the object is far away
...
float getDistance()
{
  ...
  calcualtedDistance = echoTime / 66.0;  //calculate the distance of the object that reflected the pulse (half the bounce time multiplied by the speed of sound) in cm
