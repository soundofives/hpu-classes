...
long timeLimit = 10000;               //time limit for the playe to guess each word
...
const char* words[arraySize] = {"Titus", "Fiser", "DeWitt", "Regester", "Hands", "Barlow", "Chabay", "Sherwood", "Vasquez", "Hutchens", "Berg", "Brady", "Welter", "Corcoran", "Forzley", "Thomas", "Clancy", "Novembre", "Roth", "Schorn", "White", "Worley", "Mycroft", "McClung", "Inscoe"};
...
void showStartSequence(){
  ...
  lcd.print("HPU Physics");         //print "HPU Physics:"
...
void gameOver(){
  ...
  //play the losing dark tone
  tone(buzzerPin, 262, 250);      //c
  delay(275);
  tone(buzzerPin, 294, 250);       //d
  delay(275);
  tone(buzzerPin, 330, 150);       //e
  delay(175);
...
void winner(){
  ...
  //play the 1Up noise
  tone(buzzerPin, 262, 150);     //c
  delay(100);
  tone(buzzerPin, 294, 150);     //D
  delay(100);
  tone(buzzerPin, 330, 150);     //e
  delay(100);
  tone(buzzerPin, 349, 150);     //f
  delay(100);
  tone(buzzerPin, 392, 150);     //g
  delay(100);
  tone(buzzerPin, 440, 150);     //a
  delay(100);
  tone(buzzerPin, 494, 150);     //b
  delay(100); 
  tone(buzzerPin, 523, 400);     //C
  delay(500);
